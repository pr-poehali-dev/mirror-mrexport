        ...
        <div className="container grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              SD Trade — это цифровая экосистема для международной B2B-торговли. Мы помогаем компаниям находить надёжных партнёров, проверять контрагентов и заключать сделки на прозрачных условиях.
            </p>
